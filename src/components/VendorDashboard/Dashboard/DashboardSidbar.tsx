...
import { dashboardLink } from "../../../Constant/Data";
            ...
            >
              ...
              >
                ...
                <circle
                  ...
                  cy="16.5214"
                  r="5"
                  className="fill-gray-800dark:fill-white"
                  fill="currentColor"
                />
              </svg>
            </Link>
                ...
                {dashboardLink.map((dashboard, index) => {
                  if (dashboard.list) {
                      ...
                      >
                        ...
                        >
                          <ul className="ps-8 pt-1 space-y-1">
                            {dashboard.list.map((list) => {
                              return (
                                <li>
                                  <Link
                                    className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-white/10 focus:outline-none focus:bg-white/10 "
                                    to={list.link}
                                  >
                                    {list.item}
                                  </Link>
                    ...
                    return (
                      <li>
                        <Link
                          className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-black  "
                          to={dashboard.link}
                        >
                          {dashboard.icon}
                          {dashboard.name}
