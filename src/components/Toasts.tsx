...
const Toasts = ({ type, message }: { type: string; message: string }) => {
  ...
  return (
    <div
      className="max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700 fixed bottom-4 right-4"
      role="alert"
      aria-labelledby={`${type}-toast-label`}
    >
