    ...
    <div className="bg-white rounded-lg shadow-sm">
      <div className="p-6">
        ...
        <div className="flex flex-col gap-x-3 gap-y-2">
          ...
          >
            <img
              className="person-icon rounded-full w-9 h-9"
              src="https://th.bing.com/th/id/R.3f3b68c0fde58eea7448cef9b640e299?rik=c0t2b8nVH4v%2f2g&pid=ImgRaw&r=0"
              alt="user icon"
            />
            <div className="ml-4 w-full">
              <a>
                <span className="person-name">Mark Webber</span>
                <span className="ml-2 mr-1 message-describe">
                  reacted to your recent post
                </span>
                <span className="person-group-name">
          ...
          >
            ...
            <div className="ml-4 w-full">
              <a>
                ...
                <span className="ml-2 message-describe">
              ...
              <div className="">
                <p className="text-[#73757f] p-3 mt-3 duration-150 hover:bg-[#e4eff9] hover:border-[#e4eff9] border-[##eff1f3] border-2 rounded-lg">
                  ...
                  member for a few weeks and I'm already having lots of fun and
                  improving my game.
                </p>
              </div>
            </div>
